...
We use the following methods for the analysis: Preprocessing the data for the neural network model; Compile, train and evaluate the model; optimize the model
